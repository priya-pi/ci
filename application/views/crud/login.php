...
<div class="container h-100">
    <section>
        ...
        <div class="design">
            ...
            <?php echo form_open('Login_controller/login','id="loginForm"' ,'method="post"'); ?>
            ...
            <p class="text-center text-muted mt-3 mb-0">Don't have an account? <a href="<?php echo base_url().'crud_demo/registerForm'?>" class="fw-bold text-body" ><u>Register here</u></a></p>
            <?php echo form_close(); ?>
        </div>
    </section>
</div>
