...
<div class="container h-100">
    <section>
        <div class="design">
            <?php echo form_open_multipart('crud_demo/registerForm', 'id="Register_form"', 'method="post"'); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-outline p-2">
                        ...
                        <?php echo form_password(["name" => "pass", "class" => "form-control", "value" => set_value('pass')]); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-check">
                        <?php echo form_checkbox(["name" => "hobby[]", "id" => "reading", "class" => "form-check-input ml-0", "value" => "reading", 'checked' => set_checkbox('hobby[]', 'reading')]); ?>
                        <?php echo form_label('Reading', 'reading'); ?>
                    </div>
                    <div class="form-check">
                        <?php echo form_checkbox(["name" => "hobby[]",  "id" => "writing", "class" => "form-check-input ml-0", "value" => "writing", 'checked' => set_checkbox('hobby[]', 'writing')]); ?>
                        <?php echo form_label('Writing', 'writing'); ?>
                    </div>
                    <div class="form-check">
                        <?php echo form_checkbox(["name" => "hobby[]", "id" => "coding", "class" => "form-check-input ml-0", "value" => "coding", 'checked' => set_checkbox('hobby[]', 'coding')]); ?>
                        <?php echo form_label('Coding', 'coding'); ?>
                    </div>
                    <div class="form-check">
                        <?php echo form_checkbox(["name" => "hobby[]", "id" => "playing", "class" => "form-check-input ml-0", "value" => "playing", 'checked' => set_checkbox('hobby[]', 'playing')]); ?>
                        <?php echo form_label('Playing', 'playing'); ?>
                    </div>
                    <label id="hobby[]-error" class="jquery-error" for="hobby[]"></label>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-outline p-2">
                        ...
                        <?php echo form_upload(["type" => "file", "name" => "imagefile", "class" => "form-control"]); ?>
                        <?php echo form_error('imagefile', '<p class="error">', '</p>'); ?>
            ...
            <?php echo form_close(); ?>
            <p class="text-center text-muted mt-3 mb-0">Have already an account? <a href="<?php echo base_url() . 'crud_demo/login' ?>" class="fw-bold text-body"><u>Login here</u></a></p>
        </div>
    </section>
</div>
