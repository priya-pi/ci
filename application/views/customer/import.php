...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12" id="importFrm" style="display: none;">
            <form action="<?php echo base_url() .'import/csv_import'; ?>" method="post" enctype="multipart/form-data">
                <input type="file" name="file" />
                <input type="submit" class="btn btn-primary" name="importSubmit" value="import to csv">
            </form>

			<form action="<?php echo base_url() .'import/excel_import'; ?>" method="post" enctype="multipart/form-data">
                <input type="file" name="file" />
